                    ...
                    <tbody>
                        <?php foreach ($produits as $produit) : ?>
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo $produit->Image ?>" width="100"></td>
                                <td><?php echo $produit->Marque ?></td>
                                <td><?php echo $produit->Model ?></td>
                                <td><?php echo $produit->Annee ?></td>
                                <td><?php echo $produit->Couleur ?></td>
                                <td><?php echo $produit->Prix ?></td>
                                <td><?php echo $produit->Kilometrage ?></td>
                                <td><?php echo $produit->TypeCarburant ?></td>
                                <td>
                                    <a href="../admin/edite.php?id=<?= $produit->ID ?>"><i class='bx bxs-edit-alt' style="font-size: 35px"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <div class="container my-5 cont-foot">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-5 border-top">
            ...
            <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                <li class="ms-3"><a class="text-body-secondary" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
