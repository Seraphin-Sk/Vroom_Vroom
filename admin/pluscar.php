                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                                <span><img src="../img/1.jpg" width="100%" height="100%"></span>
                                <div class="card-body">
                                    <h4 class="card-text">Jeep</h4><br>
                                    <span class="text-body-secondary">Wranglher</span><br>
                                    <span class="text-body-secondary">Voiture de terrain</span>
