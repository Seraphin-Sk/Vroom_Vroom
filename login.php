                    ...
                    <div class="modal-body p-5 pt-0">
                        <form method="post">
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control rounded-3" name="email" placeholder="nom@example.com">
                                <label for="email" class="form-label">Adresse e-mail</label>
                            </div>

                            <!-- <div class="form-floating mb-3">
                                <input type="motdepasse" class="form-control rounded-3" name="motdepasse" placeholder="Mot de passe">
                                <label for="motdepasse" class="form-label">Mot de passe</label>
                            </div> -->
                            <!-- Champ de mot de passe avec une classe Bootstrap pour le style -->
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control rounded-3" id="motdepasse" name="motdepasse" placeholder="Mot de passe">
                                <label for="motdepasse" class="form-label">Mot de passe</label>
                            </div>

                            <!-- Case à cocher pour activer/désactiver la visibilité du mot de passe -->
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="togglePassword">
                                <label class="form-check-label" for="togglePassword">Afficher le mot de passe</label>
                            </div>

                            <button class="w-100 mb-2 btn btn-lg rounded-3 btn-danger" name="envoyer" value="Se connecter"><a href="#" class="text-decoration-none text-white"> Se connecter </a></button>
                            <hr class="my-4">
                            <a href="/admin/createcompte.php" class="align-items-center text-decoration-none">
...
<!-- Script JavaScript pour gérer la visibilité du mot de passe -->
<script>
    // Ajout d'un événement lorsque la case à cocher change d'état
    document.getElementById('togglePassword').addEventListener('change', function (e) {
        // Récupère l'élément du champ de mot de passe
        ...
        if (this.checked) {
            passwordField.type = 'text'; //Affiche le mot de passe en texte clair
        } else {
